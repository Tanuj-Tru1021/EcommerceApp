                ...
                <View
                    ...
                    <View style={{ padding: 16 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginTop: 10 }}>
                            <TouchableOpacity
                                style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginRight: 4, borderWidth: 2, borderColor: 'red', padding: 4 }}
                                onPress={() => {
                                    setShowModalCart(false)
                                }}
                            >
                                <Ionicon name='close' size={30} color='red' />
                                <Text style={{ fontSize: 20, fontWeight: 500, color: 'red', marginLeft: 4 }}>
                                    NO
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: 'green', padding: 4 }}
                                onPress={() => {
                                    clearCart()
                                    setShowModalCart(false)
                                }}
                            >
                                <Ionicon name='checkmark' size={30} color='green' />
                                <Text style={{ fontSize: 20, fontWeight: 500, color: 'green', marginLeft: 4 }}>
                                    YES
                                </Text>
                            </TouchableOpacity>
                        </View>
